            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <form action='' method="POST">
                  ...
                  <div class="form-group">
                    <label for="image" class="control-label col-lg-2">Title</label>
                    <input type="text" name="title" class="form-control" value="<?php  echo $row1['small_title']; ?>" >
                  </div>    
                  <div class="form-group">
                    <label for="days" class="control-label col-lg-2">Small Description</label>
                     <input type="text" name="smalldesc" class="form-control" value=" <?php  echo $row1['paragraph']; ?>" >
                  </div>
                  <div class="form-group">
                     <label for="image" class="control-label col-lg-2">Inside Image</label>
                     <input type="file" class="form-control" name="inimage" >
                     <input type="hidden" name="local" value="http://localhost/PFM/images/">
                  </div>
                  <div class="form-group">
                    <label for="days" class="control-label col-lg-2">Main Description</label>
                     <input type="text" name="maindesc" class="form-control" value="<?php  echo $row1['description']; ?>" >
                  </div>   
                  <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <input type="hidden" name="titel1" value="">
                     <input type="hidden" name="soustitle" value="">
                     <input type="hidden" name="wowdelay" value="">
                 ...
                 <?php 
                  if (isset($_POST['submit'])) {
                    ...
                    $titel1 = $_POST['titel1'];
                    $soustitle =$_POST['soustitle'];
                    $wowdelay=$_POST['wowdelay'];

                    $image= $_POST['local'].$_POST['image'];
                    $title=$_POST['title'];
                    $smalldesc=$_POST['smalldesc'];
                    $insideimg=$_POST['local'].$_POST['inimage'];                    
                    ...
                    $query2 = "UPDATE programs SET url_img='$image', small_title='$title', paragraph='$smalldesc' , img_desc='$insideimg' , description='$description' WHERE id='$id' ";
