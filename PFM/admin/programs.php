            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Programs Table</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <header>
                              <a href="add_program.php" class="btn btn-primary" style="margin-top: 10PX;margin-bottom: 10PX;width: 200px;margin-left: 15PX;">Add New</a>
                            </header>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php echo '<tr>
                                            ...
                                            <td>'.$row['paragraph'].'</td>
                                            <td>
                                               <img class="img-circle" src="'.$row['img_desc'].'" alt="" style="height : 50PX;width : 50PX;">
                                            </td>
                                            <td>'.$row['description'].'</td>'; ?>

                                            <td>
                                            <div class="btn-group">
                                             <a class="btn btn-tbl-edit btn-xs" href="edit_programs.php?id=<?php echo $row['id'] ?>"><i class="fa fa-pencil"></i></a>
                                             <a class="btn btn-tbl-delete btn-xs" onclick="return confirm('are you sure you want to delete this entry')" href="programs.php?id=<?php echo $row['id'] ?>"><i class="fa fa-trash-o "></i></a>
                                            </div>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                        ...
                                        <?php
                                              ...
                                              {
                                                $id = $_GET['id'];
                                                $cmd = "DELETE from programs where id ='$id'";
