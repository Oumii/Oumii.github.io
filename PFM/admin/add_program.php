                ...
                <form action='' method="POST">
                  ...
                  <div class="form-group">
                    <label for="days" class="control-label col-lg-2">Small Description</label>
                     <input type="text" name="smalldesc" class="form-control" >
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="days" class="control-label col-lg-2">Main Description</label>
                     <input type="text" name="maindesc" class="form-control" >
                  </div>   
                  <div class="form-group">
                  ...
                  <?php
                    ...
                    $query2 = "INSERT INTO programs(title, sous_title, url_img, small_title, paragraph, img_desc, description, data_wow_delay) VALUES('$titel1', '$soustitle', '$image', '$title', '$smalldesc', '$insideimg', '$description', '$wowdelay')";
