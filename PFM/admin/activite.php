<?php
    ...
    $cmd = "SELECT * FROM activite, coach, salle WHERE activite.id_activ = coach.id  and activite.num_salle = salle.immatricule_salle";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <header>
                              <a href="add_activite.php" class="btn btn-primary" style="margin-top: 10PX;margin-bottom: 10PX;width: 200px;margin-left: 15PX;">Add New</a>
                            </header>
                                    ...
                                    <tbody>
                                        <?php while($row1 = mysqli_fetch_assoc($result)) {?>
                                            <form method="GET" action="">
                                                <?php $id = $row1['id_activ'];?>
                                        <?php echo '<tr>
                                            <td>
                                               <img class="img-circle" src="'.$row1['img'].'" alt="" style="height : 50PX;width : 50PX;">
                                            </td>
                                            <td class="text-center">'.$row1['nom_activ'].'</td>
                                            <td class="text-center">'.$row1['description'].'</td>
                                            <td class="text-center">'.$row1['heureD_activ'].'</td>
                                            <td class="text-center">'.$row1['heureF_activ'].'</td>
                                            <td class="text-center">'.$row1['coach'].'</td>
                                            <td class="text-center">'.$row1['num_salle'].'</td>'; ?>
                                            <td>
                                            <div class="btn-group">
                                             <a class="btn btn-tbl-edit btn-xs" href="<?php echo "edit_activite.php?id=".$id.""?>">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                             <a class="btn btn-tbl-delete btn-xs" onclick="return confirm('are you sure you want to delete this entry')" href="activite.php?id=<?php echo $row1['id_activ'] ?>">
                                        ...
                                        <?php
                                              ...
                                              {
                                                $id = $_GET['id'];
                                                $cmd = "DELETE from activite where id_activ ='$id'";
